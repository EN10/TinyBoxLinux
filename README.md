...
Tiny BusyBox Linux Distro from 4.96 MB
...
* [Linux Kernel](https://www.kernel.org) 6.7.4: `bzImage` [2.62 MB](https://github.com/EN10/BusyBoxLinux/blob/main/bootfiles/bzImage) (tinyconfig + networking)
