...
The BusyBox Linux Distro has 2 main files: [Linux Kernel](https://www.kernel.org) `bootfiles/bzImage` and [BusyBox](https://busybox.net) User space utilities `bootfiles/init.cpio.gz`.
